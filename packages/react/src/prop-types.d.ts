...
export type ReactNodeLike = ReactElementLike | ReactNodeArray | string | number | boolean | undefined;
...
export interface Requireable<T> extends Validator<T | undefined | undefined> {
